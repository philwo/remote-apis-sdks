...
def remote_apis_sdks_go_deps():
    go_repository(
        ...
        replace = "github.com/philwo/remote-apis",
        sum = "h1:1TJnIgyrWCz1WswhdbMbzKvM0ujrQaEk4pPKqbE4hgk=",
        version = "v0.0.0-20240811100849-f6984257c0f1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Qe0mtiNFHQZ296vRgUjRCoPHPqH7VdTOrZx3g0T+pGA=",
        version = "v0.4.10",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:iBPPCQZExdTY0ZE9iW0Vh7CZCj40GE0NlblMgKpFxLk=",
        version = "v0.0.0-20240808171019-573a1156607a",
    )
    go_repository(
